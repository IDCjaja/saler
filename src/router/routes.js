export default [
  ...
  {
    path: '/real_estate/saler/tradingRecordDetail',
    name: 'tradingRecordDetail',
    component: () => import(/* webpackChunkName:'tradingRecordDetail' */ '@/components/trading/tradingRecordDetail')
  },
  {
